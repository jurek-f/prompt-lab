        ...
        >
          ...
          {session.tutorEnabled && (
            <span style={{
              ...
              background: tutorBusy ? 'var(--border)' : 'var(--accent)',
              flexShrink: 0, opacity: tutorBusy ? 0.5 : 1,
            }} />
          )}
...
function About() {
  ...
  return (
    <>
      ...
      <H2>Feedback</H2>
      <p>Contact: <a href="mailto:jurek-f@hotmail.de" style={{ color: 'var(--accent)' }}>jurek-f@hotmail.de</a></p>
    </>
  )
}
...
function Privacy() {
  return (
    <>
      ...
      <H2>1. Controller</H2>
      <p>Prompt Lab is operated by Jurek Föllmer. Contact: jurek-f@hotmail.de</p>
      ...
      <H2>5. Your rights</H2>
      <p>Contact jurek-f@hotmail.de to exercise GDPR rights. Supervisory authority: <a href="https://www.bfdi.bund.de" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>BfDI</a>.</p>
    </>
  )
}
...
function Datenschutz() {
  return (
    <>
      ...
      <p>Jurek Föllmer, E-Mail: jurek-f@hotmail.de</p>
      ...
      <H2>5. Ihre Rechte</H2>
      <p>Zur Geltendmachung Ihrer Rechte (Art. 15–21 DSGVO) wenden Sie sich an: jurek-f@hotmail.de. Aufsichtsbehörde: <a href="https://www.bfdi.bund.de" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>BfDI</a>.</p>
    </>
  )
}
...
function Impressum() {
  return (
    <>
      ...
      <p><strong>Vertreten durch:</strong><br />Jurek Föllmer</p>
      <p><strong>Kontakt:</strong><br />Telefon: 0177-3959119<br />E-Mail: <a href="mailto:jurek-f@hotmail.de" style={{ color: 'var(--accent)' }}>jurek-f@hotmail.de</a></p>
      <p><strong>Verbraucherstreitbeilegung:</strong><br />Wir nehmen nicht an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teil.</p>
    </>
  )
}
